...
void main_parallel()
{
	...
	// Create and initialize the input matrices and the matrix that  holds the result.
	...
	// Print to the console the time it takes to multiply the matrices serially.
	wcout << L"serial: " << time_call([&]
		{
			matrix_multiply(m1, m2, result, size);
		}) << endl;

	// Print to the console the time it takes to multiply the matrices in parallel.
